...
export const DEFAULT_SETTINGS: SiteSettings = {
  ...
  instagram: 'https://instagram.com/danielpacheco.imoveis',
  address: 'Rua Henrique Lage, Centro, Criciúma - SC',
  businessHours: 'Segunda a Sexta: 08h30 às 19h | Sábado: 09h às 16h (Plantão de Vendas)',
