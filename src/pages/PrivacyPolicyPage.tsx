  ...
  return (
    <div id="privacy-policy-page" className="pt-28 pb-20 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8 animate-in fade-in duration-200">
      ...
      <div className="space-y-3">
        ...
        <p className="text-xs text-[#5A5A5A]">Última atualização: Fevereiro de 2026</p>
      </div>

      <div className="bg-[#FFFFFF] border border-[#E5E0D8] rounded-3xl p-6 sm:p-10 space-y-6 text-xs sm:text-sm text-[#5A5A5A] leading-relaxed shadow-sm">
        <section className="space-y-2">
          <h2 className="text-base sm:text-lg font-bold text-[#111111]">1. Compromisso com a Privacidade</h2>
          <p>
        ...
        <section className="space-y-2">
          <h2 className="text-base sm:text-lg font-bold text-[#111111]">2. Coleta de Informações</h2>
          <p>
        ...
        <section className="space-y-2">
          <h2 className="text-base sm:text-lg font-bold text-[#111111]">3. Finalidade do Tratamento</h2>
          <p>
            Os dados coletados destinam-se exclusivamente a:
          </p>
          <ul className="list-disc pl-5 space-y-1 text-[#5A5A5A]">
        ...
        <section className="space-y-2">
          <h2 className="text-base sm:text-lg font-bold text-[#111111]">4. Não Compartilhamento com Terceiros</h2>
          <p>
        ...
        <section className="space-y-2">
          <h2 className="text-base sm:text-lg font-bold text-[#111111]">5. Direitos do Titular</h2>
          <p>
